...
const MessageCreate = () => {
    ...
    const arrayOptionMapping = (array) => {
                ...
                <S.FormWrapper>
                    <S.Form id="message" onSubmit={(e) => submitFormData(e)}>
                        ...
                        <S.InputContentWrapper>
                            ...
                            <S.SelectInput id="relationship" type="select" onChange={(e) => handleChange(e)}>
                                {arrayOptionMapping(RELATION_LIST)}
                            </S.SelectInput>
                        </S.InputContentWrapper>
                        <S.InputContentWrapper>
                        ...
                        <S.InputContentWrapper>
                            ...
                            <S.SelectInput id="font" onChange={(e) => handleChange(e)}>
                                {arrayOptionMapping(FONT_LIST)}
                            </S.SelectInput>
                        </S.InputContentWrapper>
                    </S.Form>
                </S.FormWrapper>
                <S.CreateButton form="message" type="submit" disabled={isLoading}>생성하기</S.CreateButton>
            </S.EntireWrapper>
